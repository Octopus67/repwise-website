...
const features = [
  ...
  },
  {
    ...
    description: 'Your TDEE recalibrates every week from real weigh-in data. Pick from 4 coaching modes depending on how hands-on you want the app to be.',
    tags: [],
    span: '',
  },
  {
    icon: BarChart3,
    title: 'Analytics',
    description: 'Strength curves, body comp trends, fatigue scores, periodization calendar. The nerdy stuff.',
    tags: [],
    span: '',
  },
  {
    ...
    description: 'Pose overlays so your photos are actually comparable. Side-by-side any two dates.',
    tags: [],
    span: 'md:col-span-2',
  },
  {
    ...
    description: 'Training volume, nutrition compliance, weight trends, and 3-5 specific recommendations for next week.',
    tags: [],
    span: 'md:col-span-2',
  },
];
